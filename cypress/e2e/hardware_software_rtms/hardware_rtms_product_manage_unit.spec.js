describe('Hardware RTMS Product Manage Unit Test',()=>{
    ...
    it('add PURIN1',()=>{
        ...
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').wait(300).click()
        cy.get('input[class="text-right form-control"]').should('be.visible').wait(300).click().type('123')
        cy.get('button[class="btn btn-success"]').should('be.visible').wait(300).click()
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').wait(300).click()
    ...
    it('update PURIN1 to PURIN2 and change number',()=>{
        ...
        cy.get('button[class="btn btn-success"]').should('be.visible').wait(300).click()
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').wait(300).click()
        cy.get('input[class="text-right form-control"]').should('be.visible').wait(300).click().type('456')
