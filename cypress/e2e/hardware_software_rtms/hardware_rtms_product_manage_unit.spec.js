describe('Hardware RTMS Product Manage Unit Test',()=>{
    ...
    it('select advance option -> manage product -> manage product units',()=>{
    ...
    it('add PURIN1',()=>{
        ...
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').click()
        cy.get('input[class="text-right form-control"]').should('be.visible').click().type('123')
        cy.get('button[class="btn btn-success"]').should('be.visible').click()
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').click()
    ...
    it('update PURIN1 to PURIN2 and change number',()=>{
        cy.get('button[class="btn btn-info"]').eq(1).should('be.visible').click()
        cy.get('input[class="text-right form-control"]').should('be.visible').clear()
        cy.get('button[class="btn btn-success"]').should('be.visible').click()
        cy.get('button[class="swal2-confirm swal2-styled"]').should('be.visible').click()
        cy.get('input[class="text-right form-control"]').should('be.visible').click().type('456')
