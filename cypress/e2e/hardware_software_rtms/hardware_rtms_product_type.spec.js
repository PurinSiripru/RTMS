describe('Hardware RTMS Product Type Test',()=>{
    ...
    it('select advance option -> manage product -> product type',()=>{
    ...
    it('search found PURIN2',()=>{
        cy.get('input[class="form-control"]').should('be.visible').clear()
        cy.get('input[class="form-control"]').should('be.visible').wait(2000).click().type('PURIN2')
        cy.get('button[class="btn btn-info"]').eq(0).should('be.visible').click()
        cy.get('input[class="form-control"]').should('be.visible').clear()
        cy.get('button[class="btn btn-info"]').eq(0).should('be.visible').click()
    })
