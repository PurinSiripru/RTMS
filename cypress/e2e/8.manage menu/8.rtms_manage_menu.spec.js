describe('RTMS Manage Menu Test',()=>{
    ...
    it('add SLOT1 inside MENU1',()=>{
        cy.wait(1000)
        cy.get('button[class="btn btn-success"]').should('be.visible').click() // เพิ่มชั้น
        cy.wait(500)
        cy.get('button[class="btn btn-success float-right btn btn-secondary"]').should('be.visible').click()
        cy.wait(500)
        cy.get('input[class="form-control"]').should('be.visible').click()
    ...
    it('check PURIN1 product inside SLOT1',()=>{
        cy.get('button[class="btn btn-success"]').should('be.visible').click() // เพิ่มชั้น
        cy.get('button[class="btn btn-primary"]').should('be.visible').click()
        cy.wait(500)
        cy.scrollTo('bottom')
    ...
    it('change MENU1 data to MENU2 data',()=>{
    ...
    it('check PURIN2 product inside SLOT2',()=>{
        cy.get('button[class="btn btn-success"]').should('be.visible').click() // เพิ่มชั้น
        cy.get('button[class="btn btn-primary"]').should('be.visible').click()
        cy.wait(500)
        cy.scrollTo('bottom')
